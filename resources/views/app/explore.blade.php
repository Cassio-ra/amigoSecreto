<div class="flex col-span-6 col-start-4 grid grid-cols-6 mt-[1em]">
    ...
    {{-- Ia fzr alguma coisa nesses outros botões mas n tem la mtas rotas no sistema --}}
    <a href="{{ route('home') }}" class="col-span-2 col-start-3 text-center p-2 rounded-lg w-full h-full border hover:bg-gray-200 hover:border hover:border-black">
